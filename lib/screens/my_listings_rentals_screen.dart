...
class MyListingsRentalsScreen extends StatefulWidget {
  final String currentUserId;

  const MyListingsRentalsScreen({Key? key, required this.currentUserId})
    : super(key: key);

  @override
  State<MyListingsRentalsScreen> createState() =>
      _MyListingsRentalsScreenState();
}

class _MyListingsRentalsScreenState extends State<MyListingsRentalsScreen> {
    ...
    setState(() {
      ...
      if (query.isEmpty) {
        ...
        _filteredRentals = _rentals.where((rental) {
          ...
          final customerName =
              rental['customerId']?['name']?.toString().toLowerCase() ?? '';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('My Listings\' Rentals'),
        elevation: 0,
      ),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            _searchQuery.isEmpty
                ? 'Rental requests for your items will appear here'
  ...
  Widget _buildRentalCard(Map<String, dynamic> rental) {
    ...
    final customer = rental['customerId'];
